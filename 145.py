...
#add label for Name,Birth-date,Adress
...
def myCardDetails():
    ...
    print(type(Name))
    name=Nirmay Rathod
    print(type(Birth-date))
    Pin-no=401105
    print(type(Adress))
    label_name['text']=name
    label_grade['text']=Birth-date
    label_subjects['text']=Adress
#add button


button1 = Button(root, text = "Driver License", command=myCardDetails)
